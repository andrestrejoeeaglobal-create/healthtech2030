                ...
                case 'intro_sex': {
                    ...
                    if (sex !== "Masculino" && sex !== "Femenino") {
                        ...
                        if (currentAge < 18) {
                            ...
                            if (currentAge < 12) {
                                responseMsg = `Protocolo de omisión ejecutado.
...
Para el registro oficial y cálculo de requerimientos cognitivos: ¿En qué semestre de secundaria o preparatoria se encuentra **${pName}**?`;
                            }
                            nextStep = 'intro_job';
                        } else {
