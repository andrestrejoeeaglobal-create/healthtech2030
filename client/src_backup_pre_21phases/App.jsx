...
function App() {
  ...
  const handleSend = async (optionalInput = null, optionalLabel = null) => {
    if (inputHandler) {
      inputHandler(optionalInput !== null ? optionalInput : input, optionalLabel !== null ? optionalLabel : optionalInput);
      setInput("");
      return;
    }
      ...
      <div className="relative z-10 flex flex-col font-sans text-slate-600 selection:bg-blue-100 h-full w-full">
        ...
        <div className="flex flex-1 w-full overflow-hidden">
          ...
          <div className="w-1/2 flex flex-col border-r border-slate-200 bg-white shadow-xl z-10 relative">
              ...
              <>
                ...
                {currentPhase === 'PHASE_3_MOTIVO_CONSULTA' && (
                  <Fase3_MotivoConsulta
                    ...
                    setIsGlobalTyping={setIsGlobalTyping}
                ...
                {currentPhase === 'PHASE_7_HABITS' && (
                  <Fase7_Habitos
                    ...
                    onPhaseComplete={(habitsData) => {
                      ...
                      setMessages([]); // <-- CLEAR CHAT SCREEN FOR SMOOTH TRANSITION
                ...
                {currentPhase === 'PHASE_9_PHYSIOLOGICAL' && (
                ...
                {currentPhase === 'PHASE_11_DIETARY_EVAL' && (
                ...
                {currentPhase === 'PHASE_12_BIOMETRICS' && (
                  <Fase12_Biometria
                    patientData={patientData}
                    setPatientData={setPatientData}
                    messages={messages}
                ...
                {currentPhase === 'PHASE_17_DASHBOARD_RENDER' && (
                  <Fase17_Despedida
                    patientData={patientData}
                    messages={messages}
                    setMessages={setMessages}
            ...
            {currentPhase === 'PHASE_14_ORCHESTRATION_START' && (
              <Fase14_Orquestador
                onPhaseComplete={(nextPhase) => {
                  setMessages([]);
                  setCurrentPhase(nextPhase);
          ...
          <div className="w-1/2 h-full flex flex-col bg-gray-50 border-l border-gray-200 relative overflow-hidden">
            ...
            {currentPhase.startsWith('PHASE_0') ? (
