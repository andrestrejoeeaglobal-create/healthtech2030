                ...
                <div className="absolute bottom-0 left-0 right-0 bg-gradient-to-t from-white via-white to-transparent pb-8 pt-12 px-8">
                    <div className="max-w-2xl mx-auto relative group">
                        ...
                        <button
                            ...
                            className="absolute right-2 top-1/2 -translate-y-1/2 bg-[#1C75BC] text-white w-10 h-10 flex items-center justify-center rounded-full hover:bg-[#155a8a] transition-transform active:scale-95 shadow-md flex-shrink-0 disabled:opacity-50 disabled:cursor-not-allowed"
                        >
