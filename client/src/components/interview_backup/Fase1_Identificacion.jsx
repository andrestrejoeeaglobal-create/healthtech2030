                ...
                case 'intro_sex': {
                    ...
                    if (sex !== "Masculino" && sex !== "Femenino") {
                        ...
                        if (currentAge < 18) {
                            ...
                            if (currentAge < 12) {
                                responseMsg = `Protocolo de omisión ejecutado.\n\n---\n\nAl tratarse de un paciente en etapa pediátrica, el sistema ha bloqueado automáticamente la recolección de estado civil y actividad laboral para proteger su expediente.\n\nPara mapear correctamente su gasto energético y exposición ambiental diaria: ¿**${pName}** asiste a guardería o kínder actualmente?`;
                            } else {
                                responseMsg = `Protocolo de omisión ejecutado.\n\n---\n\nAl tratarse de un paciente en etapa adolescente, el sistema ha bloqueado automáticamente la recolección de estado civil para proteger tu expediente.\n\nPara tu registro oficial y cálculo de requerimientos cognitivos: ¿En qué semestre de secundaria o preparatoria te encuentras?`;
                            }
                            nextStep = 'intro_job';
                        } else {
